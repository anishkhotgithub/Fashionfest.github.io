...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="clothes.jsp">
      <input class="form-control mr-sm-2" type="search" name="clothesname" placeholder="Search" aria-label="Search">
